 ...
 */
final class Version20240320233319 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE company_representation_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE SEQUENCE contract_meta_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE contract_result_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE contract_template_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE company (id INT NOT NULL, address_id INT NOT NULL, name VARCHAR(255) NOT NULL, shortname VARCHAR(50) NOT NULL, vatin VARCHAR(50) NOT NULL, court_registry VARCHAR(255) NOT NULL, registry_number VARCHAR(30) NOT NULL, initial_capital VARCHAR(255) NOT NULL, dpo_email_address VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE contract (id INT NOT NULL, company_id INT NOT NULL, representation_id INT NOT NULL, contractor_id INT NOT NULL, contractor_bank_account_id INT NOT NULL, contract_template_id INT NOT NULL, contract_number VARCHAR(255) NOT NULL, issued_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, terminated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, paid_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, contract_value_net INT NOT NULL, contract_value_gross INT NOT NULL, contract_value_tax INT NOT NULL, subject VARCHAR(255) NOT NULL, results TEXT DEFAULT NULL, is_paid BOOLEAN NOT NULL, is_tax_paid BOOLEAN NOT NULL, is_undersigned BOOLEAN NOT NULL, is_booked BOOLEAN NOT NULL, is_result_delivered BOOLEAN NOT NULL, conclusion_place VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE contract_template (id INT NOT NULL, name VARCHAR(255) NOT NULL, language_code VARCHAR(5) NOT NULL, contract_template_path VARCHAR(255) NOT NULL, bill_template_path VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE company_representation_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE contract_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE contract_attachment_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE contract_meta_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE contract_result_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE contract_template_id_seq CASCADE');
